...
export default function AdminSidebar({
  ...
  return (
    <>
      <aside
        className={`fixed md:static inset-y-0 left-0 z-50 w-64 h-screen bg-[#1a1c21] text-gray-300 p-6 flex flex-col justify-between border-r border-gray-800 transition-transform duration-300 ${
      ...
      >
        ...
        <button
          ...
          className="w-full bg-emerald-600 hover:bg-emerald-700 text-white py-3 rounded-xl font-bold transition-all shadow-lg shadow-emerald-900/20"
        >
          {isExist ? "Logout" : "Login"}
        </button>
      </aside>
