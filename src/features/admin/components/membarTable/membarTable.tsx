...
//   const [delete]=useUserDeleteMutation()
//   if (isLoading) {
...
//                 <td className="py-4">
//                   <span
//                     className={`px-3 py-1 rounded-full text-[11px] ${m.status === "সক্রিয়" ? "bg-emerald-900/50 text-emerald-400" : "bg-red-900/50 text-red-400"}`}
//                   >
//                     {m.status}
//                   </span>
//                 </td>
...
//                     <Edit2 size={16} />
//                   </button>
//                   <button className="p-2 bg-red-900/30 rounded-lg text-red-500">
//                     <Trash2 size={16} />
//                   </button>
//                 </td>
//               </tr>
...
//           <div
//             key={m.id}
//             className="bg-[#121417] p-4 rounded-xl border border-gray-800 flex items-center gap-4"
//           >
...
//           <button
//             key={n}
//             className={`w-8 h-8 rounded-md ${n === 1 ? "bg-emerald-600" : "bg-[#121417] hover:bg-gray-800"}`}
//           >
//             {n}
//           </button>
//         ))}
          ...
          <tbody>
            {users.map((m: IUser) => (
              ...
              >
                ...
                <td className="py-4">{m.phone}</td>
                <td className="py-4">{m.bloodGroup}</td>
