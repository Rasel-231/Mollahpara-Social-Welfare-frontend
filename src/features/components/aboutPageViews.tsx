...
const milestones = [
  {
    year: "২০২৬",
    titleBn: "প্রতিষ্ঠা ও যাত্রা",
    descBn: "মোল্লাপাড়া সমাজ কল্যাণ সংস্থার নতুন পথচলা শুরু।",
    icon: "🌱",
  },
  {
    year: "২০২৭",
    titleBn: "স্বাস্থ্য কেন্দ্র",
    descBn: "এলাকায় একটি স্থায়ী কমিউনিটি হেলথ কেয়ার সেন্টার প্রতিষ্ঠা।",
    icon: "🩺",
  },
  {
    year: "২০২৮",
    titleBn: "কারিগরি প্রশিক্ষণ",
    descBn: "বেকার যুবকদের জন্য বিনামূল্যে কারিগরি ও আইটি প্রশিক্ষণ কেন্দ্র।",
    icon: "💻",
  },
  {
    year: "২০২৯",
    titleBn: "পরিবেশ প্রকল্প",
    descBn: "বৃক্ষরোপণ ও পরিচ্ছন্ন গ্রাম গড়তে ব্যাপক পরিবেশ কর্মসূচি।",
    icon: "🌿",
  },
  {
    year: "২০৩০",
    titleBn: "স্বনির্ভরতা",
    descBn:
      "ক্ষুদ্র উদ্যোক্তাদের সহায়তায় একটি পূর্ণাঙ্গ কো-অপারেটিভ মডেল তৈরি।",
    icon: "📈",
  },
  {
    year: "২০৩১",
    titleBn: "ভিশন ২০৩১",
    descBn: "মোল্লাপাড়াকে একটি আদর্শ ও মডেল সমাজ হিসেবে গড়ে তোলা।",
    icon: "🏆",
  },
];
const values = [
  {
    icon: Heart,
    titleBn: "মানবতা",
    descBn: "প্রতিটি মানুষের মর্যাদা ও অধিকারের প্রতি শ্রদ্ধাশীল।",
    color: "text-red-500",
    bg: "bg-red-50",
  },
  {
    icon: Users,
    titleBn: "একতা",
    descBn: "সম্মিলিত প্রচেষ্টায় সমাজ পরিবর্তন সম্ভব।",
    color: "text-welfare-green-600",
    bg: "bg-welfare-green-50",
  },
  {
    icon: Award,
    titleBn: "সততা",
    descBn: "স্বচ্ছতা ও জবাবদিহিতা আমাদের মূলনীতি।",
    color: "text-welfare-gold-600",
    bg: "bg-welfare-gold-50",
  },
  {
    icon: BookOpen,
    titleBn: "শিক্ষা",
    descBn: "শিক্ষার মাধ্যমে সমাজের উন্নয়ন।",
    color: "text-blue-600",
    bg: "bg-blue-50",
  },
];
    ...
    >
      <div className={`flex-1 ${isLeft ? "text-right" : "text-left"}`}>
        ...
        >
          ...
          <h3 className="font-bold text-welfare-green-800 font-bengali mb-1">
            {item.titleBn}
          </h3>
          <p className="text-welfare-green-600 text-sm font-bengali">
            {item.descBn}
          </p>
        </div>
      </div>
  ...
  return (
    <div className="min-h-screen parchment-bg pt-20 pb-16">
      <div className="container mx-auto px-4 lg:px-6">
        ...
        >
          ...
          <div className="relative z-10 p-10 lg:p-16">
            ...
            <p className="text-white font-bengali text-base lg:text-lg leading-8 max-w-2xl">
              মোল্লাপাড়া সমাজ কল্যাণ সংস্থা একটি অলাভজনক সংগঠন যা ২০২৬ সাল থেকে
              এলাকার মানুষের কল্যাণে নিরলস কাজ করে যাচ্ছে।
            </p>
          </div>
        </motion.div>
          ...
          {[
            {
              ...
              descBn:
                "এলাকার প্রতিটি মানুষের জীবনমান উন্নয়নে অবদান রাখা। রক্তদান, শিক্ষা, স্বাস্থ্য ও আর্থিক সহায়তার মাধ্যমে একটি সুখী-সমৃদ্ধ সমাজ গড়ে তোলা।",
            ...
            },
            {
              ...
              descBn:
                "এমন একটি সমাজ গড়ার স্বপ্ন যেখানে কোনো মানুষ অসহায় নয়, প্রতিটি শিশু শিক্ষার সুযোগ পাবে এবং সকলের মৌলিক অধিকার নিশ্চিত থাকবে।",
            ...
            >
              <div
                ...
                style={{
                  background: `linear-gradient(135deg, ${gradient.includes("green") ? "#14532d, #166534" : "#92400e, #b45309"})`,
                }}
              />
              <div className="relative z-10">
                ...
                <p className="text-white/85 font-bengali leading-7 text-sm lg:text-base">
                  {descBn}
                </p>
              </div>
            </motion.div>
        ...
        <div ref={heroRef} className="mb-16">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-5">
            {values.map(({ icon: Icon, titleBn, descBn, color, bg }, i) => (
              ...
              >
                <div
                  className={`w-12 h-12 rounded-xl ${bg} flex items-center justify-center mx-auto mb-3`}
                >
                  <Icon size={24} className={color} />
                </div>
                <h3 className={`font-bold font-bengali mb-2 ${color}`}>
                  {titleBn}
                </h3>
        ...
        <div className="mb-16">
          <h2 className="section-title-center mb-12 font-bengali">
            আমাদের যাত্রা
          </h2>
        ...
        >
          <h2 className="text-2xl font-bold text-white font-bengali mb-3">
            আমাদের সাথে যুক্ত হন
          </h2>
          <p className="text-welfare-green-200 font-bengali mb-6 max-w-lg mx-auto text-sm">
            একসাথে আমরা একটি সুন্দর সমাজ গড়তে পারি। আজই আমাদের স্বেচ্ছাসেবী দলে
            যোগ দিন।
          </p>
