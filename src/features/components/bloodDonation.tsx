          ...
          <div className="md:flex-[0.55] p-6 sm:p-8 flex flex-col justify-between">
            <div>
              ...
              <p className="text-sm md:text-base leading-relaxed mb-8 font-bengali">
                কমিউনিটি সোশ্যাল ক্লাব — আবেদনের ভিত্তিতে যোগাযোগ করে রক্ত সংগ্রহের ব্যবস্থা করে। জরুরী প্রয়োজনে নিকটবর্তী হাসপাতাল ও ক্লিনিকে রক্ত সরবরাহ করা হয়। দলবদ্ধ শিক্ষার মাধ্যমে মানুষের মানবতার জাগরণের অনলাইন সন্ধান ও বাস্তব কাজের হামাগুড়ি।
              </p>
            </div>
