...
> = {
  ...
  event: {
    label: "অনুষ্ঠান",
    color: "text-welfare-gold-700",
    bg: "bg-welfare-gold-100",
  },
  announcement: {
    label: "ঘোষণা",
    color: "text-welfare-green-700",
    bg: "bg-welfare-green-100",
  },
    ...
    return (
      <div className="min-h-[60vh] flex items-center justify-center px-4">
        <div className="text-center">
          ...
          <p className="text-welfare-green-500 font-bengali">
  ...
  return (
    <div className="min-h-screen parchment-bg pt-20 pb-16">
      <div className="container mx-auto px-4 lg:px-6">
        ...
        >
          <div className="absolute right-8 text-8xl opacity-10 select-none top-1/2 -translate-y-1/2">
            📰
          </div>
          <div className="relative z-10">
            ...
            <p className="text-welfare-green-200 font-bengali text-sm lg:text-base">
              সাম্প্রতিক কার্যক্রম, ঘোষণা ও গল্পগুলো
            </p>
          </div>
        </motion.div>
              ...
              <div className="flex flex-col md:flex-row">
                ...
                <div className="flex-1 p-6 lg:p-8 flex flex-col justify-center">
                  <div className="flex items-center gap-2 mb-3">
                    <span
                      className={`px-2.5 py-1 rounded-lg text-xs font-bold ${categoryInfo[typeToCategory[filtered[0].type]]?.bg ?? "bg-gray-100"} ${categoryInfo[typeToCategory[filtered[0].type]]?.color ?? "text-gray-700"}`}
                    >
                      {categoryInfo[typeToCategory[filtered[0].type]]?.label ??
                        filtered[0].type}
                    </span>
                    <span className="text-welfare-green-400 text-xs">
                      সর্বশেষ
                    </span>
                  </div>
                  ...
                  <p className="text-welfare-green-600 font-bengali text-sm leading-6 mb-4">
                    {getExcerpt(filtered[0].content)}
                  </p>
            ...
            <Link key={article.id} href={`/news/${article.id}`}>
              ...
              >
                {article.image && (
                  <div className="relative aspect-video overflow-hidden rounded-t-2xl">
                    ...
                    <div className="absolute top-3 left-3">
                      <span
                        className={`px-2 py-1 rounded-lg text-xs font-bold ${categoryInfo[typeToCategory[article.type]]?.bg ?? "bg-gray-100"} ${categoryInfo[typeToCategory[article.type]]?.color ?? "text-gray-700"}`}
                      >
                        {categoryInfo[typeToCategory[article.type]]?.label ??
                          article.type}
                      </span>
                    </div>
                  </div>
                ...
                <div className="p-4">
                  ...
                  <p className="text-welfare-green-500 text-xs font-bengali leading-5 mb-3 line-clamp-2">
