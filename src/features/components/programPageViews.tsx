...
const programs = [
  {
    ...
    descBn:
      "আমাদের রক্তদান কর্মসূচি এলাকার রোগীদের জন্য জরুরি রক্ত সরবরাহ নিশ্চিত করে। স্বেচ্ছাসেবী রক্তদাতাদের একটি বৃহৎ নেটওয়ার্কের মাধ্যমে যেকোনো জরুরি পরিস্থিতিতে রক্ত সংগ্রহ করা হয়।",
    image:
      "https://images.unsplash.com/photo-1615461066841-6116e61058f4?w=700&q=80",
    href: "/blood-donation",
    ctaBn: "রক্তদান পেজে যান",
    accentFrom: "#991b1b",
    accentTo: "#dc2626",
    features: [
      "২৪/৭ জরুরি রক্ত সরবরাহ",
      "সকল রক্তের গ্রুপ উপলব্ধ",
      "নিবন্ধিত স্বেচ্ছাসেবী দাতা",
      "হাসপাতাল সমন্বয়",
      "বিনামূল্যে রক্তের গ্রুপ পরীক্ষা",
      "দাতাদের স্বাস্থ্য সুরক্ষা",
    ],
    stats: [
      { value: "৫০০+", label: "মোট রক্তদান" },
      { value: "২০০+", label: "নিবন্ধিত দাতা" },
      { value: "৫০+", label: "হাসপাতাল সংযোগ" },
    ],
  },
  {
    id: "education",
    ...
    stats: [
      { value: "২০০+", label: "বৃত্তিপ্রাপ্ত" },
      { value: "৫০+", label: "বিদ্যালয় সংযুক্ত" },
  ...
  },
  {
    ...
    stats: [
      ...
      { value: "৳২০L+", label: "ঋণ বিতরণ" },
      { value: "৯৮%", label: "পরিশোধের হার" },
    ],
  },
];
...
function ProgramCard({
  ...
  return (
    <motion.div
      ...
      className="welfare-card overflow-hidden mb-10 scroll-mt-24"
    >
      <div
        className="h-1.5 w-full"
        style={{
          background: `linear-gradient(90deg, ${prog.accentFrom}, ${prog.accentTo})`,
        }}
      />
      <div
      ...
      >
        ...
        >
          ...
          />
          <div className="absolute bottom-4 right-4 text-5xl opacity-60">
            {prog.icon}
          </div>
        </div>
        <div className="flex-1 p-7 lg:p-10">
          <span
            className="inline-block px-4 py-1.5 rounded-full text-white text-xs font-bold mb-4"
            style={{
          ...
          <p
            ...
            style={{ color: prog.accentFrom }}
          >
            {prog.tagline}
          </p>
          <p className="text-welfare-green-700 text-sm mb-5 leading-7">
            {prog.descBn}
          </p>
          <ul className="grid grid-cols-1 sm:grid-cols-2 gap-2 mb-6">
            {prog.features.map((f) => (
              <li
                key={f}
                className="flex items-center gap-2 text-sm text-welfare-green-700"
              >
...
export default function ProgramsPageView() {
  const {
    ...
    reset,
  } = useForm<LoanInput>({ resolver: zodResolver(LoanSchema) });
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="mb-12">
          <button
            ...
            className="w-full flex items-center justify-between px-7 py-5 rounded-2xl font-bold text-white mb-2"
            ...
            {open && (
              ...
              >
                <form
                  ...
                  className="welfare-card p-7 grid grid-cols-1 md:grid-cols-2 gap-5"
                >
                  <input
                  ...
                  <button
                    ...
                    className="md:col-span-2 py-4 bg-orange-700 text-white rounded-xl"
                  >
